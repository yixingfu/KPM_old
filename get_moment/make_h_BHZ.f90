...
! Last Modified=Sun 13 May 2018 05:38:22 PM DST
      ! This version, not the simple version,
      ! includes treatment for BHZ model
      ! It can also be used for simple models,
      ! but wastes some computation.
      !This file creates H
